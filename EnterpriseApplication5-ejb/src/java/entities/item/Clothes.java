...
@NamedQueries({
    ...
    , @NamedQuery(name = "Clothes.findByProductProductID", query = "SELECT c FROM Clothes c WHERE c.productProductID = :productProductID")})
public class Clothes implements Serializable {
    ...
    public Clothes(Integer productProductID) {
    ...
    public String toString() {
        return "entities.Clothes[ productProductID=" + productProductID + " ]";
    }
